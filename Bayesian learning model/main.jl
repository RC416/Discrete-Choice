...
true_quality = [-0.63, 1.20, 0.00]      # true product quality 
Q₀  = [-1.5, -1.8, -2.45]               # product quality belief prior means normal distributed
σ²₀ = [0.16, 0.07, 0.61]                # mean parameters for distribution of individual variance beliefs (̂σⱼ₀)
σ²ₑ = [0.05]                            # variance of experience signals
...
free_parameter_indices = [2,3,4,6,7,8,9,10,12]
